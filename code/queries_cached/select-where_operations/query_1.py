...
def query_pandas_1m():
    ...
    result = ratings_1m.query('timestamp >= 788918400')
    print('##########################')
...
def query_pandas_1m_b():
    ...
    result = ratings_1m.query('timestamp >= 820454400')
    print('##########################')
...
def query_pandas_10m():
    ...
    result = ratings_10m.query('timestamp >= 788918400')
    print('##########################')
...
def query_pandas_10m_b():
    ...
    result = ratings_10m.query('timestamp >= 820454400')
    print('##########################')
...
def query_pandas_20m():
    ...
    result = ratings_20m.query('timestamp >= 788918400')
    print('##########################')
...
def query_pandas_20m_b():
    ...
    result = ratings_20m.query('timestamp >= 820454400')
    print('##########################')
...
def query_pygdf_1m():
    ...
    result = df_ratings_1m.query('timestamp >= 788918400')
    print('##########################')
...
def query_pygdf_1m_b():
    ...
    result = df_ratings_1m.query('timestamp >= 820454400')
    print('##########################')
...
def query_pygdf_10m():
    ...
    result = df_ratings_10m.query('timestamp >= 788918400')
    print('##########################')
...
def query_pygdf_10m_b():
    ...
    result = df_ratings_10m.query('timestamp >= 820454400')
    print('##########################')
...
def query_pygdf_20m():
    ...
    result = df_ratings_20m.query('timestamp >= 788918400')
    print('##########################')
...
def query_pygdf_20m_b():
    ...
    result = df_ratings_20m.query('timestamp >= 820454400')
    print('##########################')
